...
\begin{block}{\Large Practical Takeaways for Operators}
    ...
    \begin{columns}[c]
        \begin{column}{0.62\linewidth}
            {\footnotesize \textbf{Reference:} Hu, R., Szeto, W.Y., \& Ho, S.C. (2025). Repositioning in bike sharing systems with broken bikes considering on-site repairs. \textit{Transportation Research Part E}, 195, 104155.}
